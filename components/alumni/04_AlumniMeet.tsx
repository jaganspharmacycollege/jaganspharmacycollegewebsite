                ...
                <div className={styles.twoColGrid}>
                    <div>
                        ...
                        <p className={styles.descText}>
                            Our Annual Alumni Homecoming Meet brings together graduates across all batches
                            to reconnect with professors, mentor current students, exchange industrial insights,
                            and celebrate their shared foundation at Jagan&apos;s College of Pharmacy.
                        </p>
                    </div>
