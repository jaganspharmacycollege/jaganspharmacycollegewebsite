...
const features = [
    {
        ...
        desc: 'Full-size cricket turf, volleyball, and basketball courts.',
    ...
    },
    {
        ...
        desc: 'Equipped gym, badminton courts, chess, and table tennis.',
